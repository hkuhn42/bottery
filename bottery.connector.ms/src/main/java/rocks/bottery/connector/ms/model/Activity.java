...
@XmlType(name = "Activity", propOrder = { "type", "id", "timestamp", "localTimestamp", "serviceUrl", "channelId", "from", "conversation", "recipient",
        "textFormat", "attachmentLayout", "membersAdded", "membersRemoved", "topicName", "historyDisclosed", "locale", "text", "summary", "attachments",
        "entities", "channelData", "action", "replyToId", "value" })
